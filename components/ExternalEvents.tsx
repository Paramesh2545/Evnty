...
import { EXTERNAL_EVENTS } from '../constants';
  ...
  return (
    <section className="py-12">
        ...
        <div className="space-y-6">
            {EXTERNAL_EVENTS.map(event => (
                <div key={event.id} className="bg-[#10141D] p-6 rounded-lg shadow-md border border-gray-800 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 hover:border-indigo-500/50 transition-colors">
                    <div>
